...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    // Remove automatic navigation listener for now
  }
  ...
  async loadMicrofrontend(appName: string) {
    try {
      ...
      // Navigate to the supply-chain route instead of embedding
      const remoteEntryUrl = environment.remotes.supplyChain;
      const baseUrl = remoteEntryUrl.replace('/remoteEntry.js', '');
      
      // Open in same window to preserve all screens and routing
